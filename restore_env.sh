...
# Usage: bash restore_env.sh    (requires conda; then `conda activate paper12`)
set -e
...
conda run -n paper12 Rscript - <<'RS'
...
echo "Done. Activate with: conda activate paper12"
echo "Third-party jars (Beagle 5.5, Stairway Plot v2.1.2) are fetched to analysis/tools/ by"
echo "their stage scripts; PLINK 1.9 is shared at ../manuscript_6_gwas_nue/scripts/Plink1.9/."
